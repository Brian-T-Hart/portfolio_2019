				...
				<div className="modal-dialog" role="document">
					<div className="modal-content">
						<div className="modal-header justify-content-center">
							<img src={props.project.image_link} />
						</div>
						...
						<div className="modal-body">
							...
							<div className="d-flex justify-content-center project-links">
								<a className="project-link pr-3" href={props.project.github_link} target="_blank">view code</a>

								<a className="project-link pl-3" href={props.project.web_link} target="_blank">view site</a>
							</div>
						</div>
